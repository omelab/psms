...
@section('content')
<div class="bg-top relative flex items-start pt-12 pb-56 m-4 overflow-hidden bg-cover min-h-50-screen rounded-xl" style="background: url({{asset('assets/img/school-child.jpg')}}) top center  fixed no-repeat; background-size:cover;">
  ...
  <div class="container z-10">
    <div class="flex flex-wrap justify-center -mx-3">
      <div class="w-full max-w-full px-3 mx-auto mt-0 text-center lg:flex-0 shrink-0 lg:w-5/12">
        <h1 class="mt-12 mb-2 text-white">The family school!</h1>
        <p class="text-white">Let’s be all that we can be with a great education for you and me Creating Our Children’s Future.</p>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="w-full max-w-full px-3 mx-auto mt-0 md:flex-0 shrink-0 md:w-7/12 lg:w-5/12 xl:w-4/12">
      <div class="relative z-0 flex flex-col min-w-0 break-words bg-white border-0 shadow-xl rounded-2xl bg-clip-border">
        ...
        <div class="flex-auto p-6">
          {!! Form::open(['route' => 'admin.register', "role"=>"form text-left"]) !!}
            <div class="mb-4">
              {!! Form::text("name", null,[
            ...
            <div class="mb-4">
                ...
                @error('email')
                <div class="text-red-500 text-small text-left align-middle">{{ $message }}</div>
                @enderror 
            </div>
            <div class="mb-4">
            ...
            <p class="mt-4 mb-0 leading-normal text-sm">Already have an account? <a href="{{route('admin.register-view')}}" class="font-bold text-slate-700">Sign in</a></p>
          {!! Form::close() !!}
        </div>
      </div>
    </div>
